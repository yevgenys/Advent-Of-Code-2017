def input():
    ...
    seperator = \t
    """
    return """4347	3350	196	162	233	4932	4419	3485	4509	4287	4433	4033	207	3682	2193	4223
...
def part_2(input_):
    sm = 0
    for line in input_.splitlines():
        sorted_digit_line = sorted(map(int, line.split("\t")))
        for element_from_start in sorted_digit_line:
